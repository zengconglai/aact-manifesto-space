...
export const BetweenTwoWorlds = {
    artist1:{
        ...
        description: 
            "<em>Conflict with the Internal Occident and the External Orient</em>\n" + 
