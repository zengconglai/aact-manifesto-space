...
import { ResilienceInCommunity } from '@/data/ResilienceInCommunity.js';
...
const ResilienceInCommunityArray = computed(() => Object.values(ResilienceInCommunity));
    ...
    <div class="min-h-screen bg-ivory max-h-full">
        <div class="sticky z-50 top-0 bg-ivory pt-4 sm:pt-6 lg:pt-4 px-6 sm:px-12 lg:px-16">
            ...
            <div class="pt-3.5 hidden lg:flex lg:justify-start lg:items-center pb-6 lg:pb-3">
                <BreadCrumbs 
                    ...
                    current-section="Resilience in Community"
                />
            </div>
            ...
            <nav ref="navbar" class="bg-ivory t-0 border-b border-stone-600 lg:pb-2 flex space-x-5 overflow-x-auto max-w-screen text-sm scrollbar-hide">
                ...
                <a v-for="(artist, index) in ResilienceInCommunityArray" :key="'nav_item_' + index" :href="`#artist_${index}`" class="nav-item inline-block whitespace-nowrap" :class="{ 'font-semibold text-stone-800': activeIndex == index + 1, 'text-stone-500': activeIndex != index + 1 }">
                    {{artist.artist_name}}
                </a>
            </nav>
        </div>
        <div class="flex flex-col items-center justify-center min-h-screen" 
            ...
            <div class="overflow-scroll scroll-smooth">
                <!-- Banner -->
                <section id="page_banner" class="h-[calc(100vh-89px)] w-full bg-cover bg-top banner7-url">
                ...
                <section id="about" class="h-fit px-6 sm:px-12 lg:px-16">
                    ...
                    <p class="pb-[60px] font-normal text-sm sm:text-base leading-5 sm:leading-6 lg:leading-8">
                        <i>Resilience in Community</i> explores the power of community, traditions, and creative way of expression as vessels for mental wellness. Through the artworks, we explore how cultural healing practices, intergenerational wisdom, and solidarity within the diaspora contribute to emotional resilience and collective well-being. Through a reflection on the strength of shared history, the nurturing of cultural bonds, and the transformative power of creative expression, such as painting, dance, and the soothing sounds of nature, the artworks explore new ways to heal, nurture, and empower, ultimately fostering mental well-being.
                    </p>
                </section>
                <div v-for="(artist,index) in ResilienceInCommunityArray" :key="index">
                    <!-- Quote of the Topic -->
