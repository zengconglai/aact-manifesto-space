        ...
        <div class="overflow-scroll scroll-smooth">
            ...
            <section id="about" class="h-fit px-6 sm:px-12 lg:px-16">
                ...
                <p class="pb-[60px] font-normal text-sm sm:text-base leading-5 sm:leading-6 lg:leading-8">
                    Resilience in Community explores the ways in which Asian queer communities build and maintain resilience through collective support, cultural preservation, and mutual aid. This section examines how these communities navigate challenges while creating spaces of belonging and empowerment.
                </p>
            </section>
            ...
            <div class="pt-6 lg:px-16 sm:px-12 px-6">
                ...
                <div class="flex flex-col lg:flex-row">
                    <div class="w-full h-60 lg:w-1/2 lg:h-[30rem] bg-top bg-cover" style="background-image: url('../assets/ResilienceInCommunity/Ayumi/Height-2.jpeg')">
                    ...
                    <div class="w-full h-60 lg:w-1/2 lg:h-[30rem] bg-top bg-cover" style="background-image: url('../assets/ResilienceInCommunity/Sarah/MOTHERWING.jpeg')">
...
<style>
.banner1-url {
    background-image: url('../assets/ResilienceInCommunity/Ayumi/Height-2.jpeg');
}
</style>